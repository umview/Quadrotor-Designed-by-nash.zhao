...
//arr：自动重装值
//psc：时钟预分频数
void TIM9_OC1_PWM_Init(u32 arr,u32 psc)
{		 					 
	//此部分需手动修改IO口设置
...
void TIM9_OC2_PWM_Init(u32 arr,u32 psc)
{		 					 
	//此部分需手动修改IO口设置
...
//arr：自动重装值
//psc：时钟预分频数
void TIM2_OC3_PWM_Init(u32 arr,u32 psc)
{		 					 
	//此部分需手动修改IO口设置
...
//arr：自动重装值
//psc：时钟预分频数
void TIM2_OC4_PWM_Init(u32 arr,u32 psc)
{		 					 
	//此部分需手动修改IO口设置
