...
#define OLED_SCL(x)  GPIODout(4)=(x)//gpio_set (OLED_SCL_PIN	, x)
#define OLED_SDA(x)  GPIODout(7)=(x)//gpio_set (OLED_SDA_PIN	, x)
#define OLED_RST(x)  GPIODout(13)=(x)//gpio_set (OLED_RST_PIN	, x)
#define OLED_DC(x)   GPIOFout(10)=(x)//gpio_set (OLED_DC_PIN	, x)
...
*/
  ...
  RCC_AHB1PeriphClockCmd(RCC_AHB1Periph_GPIOD|RCC_AHB1Periph_GPIOF,ENABLE);	
	gpio.GPIO_Pin = GPIO_Pin_4 | GPIO_Pin_7|GPIO_Pin_13;
