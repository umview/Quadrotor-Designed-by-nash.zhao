...
*/
#ifdef STM32F429CORE
#define IIC_SCL_H()      GPIO_SetBits(GPIOH,GPIO_Pin_4)
#define IIC_SCL_L()      GPIO_ResetBits(GPIOH,GPIO_Pin_4)
#define IIC_SDA_H()      GPIO_SetBits(GPIOH,GPIO_Pin_5)
#define IIC_SDA_L()      GPIO_ResetBits(GPIOH,GPIO_Pin_5)
#define IIC_SDA_Read()   GPIO_ReadInputDataBit(GPIOH,GPIO_Pin_5)
#else 
#define IIC_SCL_H()      GPIO_SetBits(GPIOB,GPIO_Pin_6)
#define IIC_SCL_L()      GPIO_ResetBits(GPIOB,GPIO_Pin_6)
#define IIC_SDA_H()      GPIO_SetBits(GPIOB,GPIO_Pin_7)
